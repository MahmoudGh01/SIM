...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val initialFragment = NewsFragment() // Replace with the fragment you want to show initially
        val initialTag = "NewsFragment" // Replace with the tag for the initial fragment
